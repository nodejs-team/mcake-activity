    ...
    function hobYU(callBack) {
        ...
        var HONGBAO = setInterval(function() {
            ...
            var HTML_i = $('<i class="hb" style="background: url(https://act.mcake.com/fangli/2021/wap/summer/images/pumpkin-'+_src[parseInt(Math.random() * 3)]+'.png) center no-repeat;  background-size:' +_r[parseInt(Math.random() * 4)] + ';top:' + -200+'px; left:' +  random + '%"><b></b></i>');
