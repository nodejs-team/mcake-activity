    ...
    */
    function SelectShow(ele,arr,d,isShow,n,db) {
        ...
        if(pondsingle<0){
            ...
            $price.html((prices-0).toFixed(1));
            $newprice.html(((prices-disCount)*dis).toFixed(1));
            ...
            $price.html((prices[n]-0).toFixed(1));
            $newprice.html(((prices[n]-disCount)*dis).toFixed(1));
            ...
            /*判断原价和现价是否一致，如果一致，原价不显示；d为1，说明不打折  db第二件是否半价*/
            newPrice = ((prices[n]-disCount)*dis).toFixed(1);
            totaPrice = (prices[n]-0).toFixed(1);
            ...
            for(var i=0; i<len; i++){
                ...
                $bangshu.find("li").each(function (i) {
                    ...
                    $(this).click(function () {
                        ...
                        $price.html(totaPrice.toFixed(1));
                        $newprice.html((newPrice).toFixed(1));
