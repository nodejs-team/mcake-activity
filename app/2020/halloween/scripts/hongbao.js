    ...
    function hobYU(callBack) {
        ...
        var HONGBAO = setInterval(function() {
            ...
            var HTML_i = $('<i class="hb" style="background: url(https://act.mcake.com/fangli/2020/wap/halloween/images/pumpkin-'+_src[parseInt(Math.random() * 3)]+'.png) center no-repeat;  background-size:' +_r[parseInt(Math.random() * 4)] + ';top:' + -200+'px; left:' +  random + '%"><b></b></i>');
 ...
 /*   $(document).on("click","i.hb",function(){
       ...
       /!* $(".flower-num").text(len);*!/
        $(".quan-1").fadeIn(0);
        console.log(len);
        $(".quan-txt").attr("src","images/txt-2.png");
        if(len<=10){
            $(".mod-body").fadeOut(0);
            $(".flower-1").fadeIn(100);
            $(".quan-1").fadeIn(0);
