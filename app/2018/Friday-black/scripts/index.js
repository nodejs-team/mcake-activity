;(function(){
    ...
    var initScroll = function (){
        window.scrollAnimate('#evt_container', [
            ...
            ,{dom: '.sec-1 .title',x:0, y:50,duration:500,delay:600}
            ,{dom: '.sec-1 .quan',x:0, y:50,duration:500,delay:600}
            ,{dom: '.sec-1 .quan-txt',x:0, y:50,duration:500,delay:600}

            ,{dom: '.zhekou .title',x:0, y:50,duration:500,delay:400}
            ,{dom: '.zhekou .prolist',x:0, y:50,duration:500,delay:400}
            ,{dom: '.sec-2 .title',x:0, y:50,duration:500,delay:400}
            ,{dom: '.sec-2 .quan',x:0, y:50,duration:500,delay:400}
            ,{dom: '.sec-2 .quan-txt',x:0, y:50,duration:500,delay:400}
