   ...
   /*推荐列表选择磅数*/
    ...
    var initScroll = function (){
        window.scrollAnimate('#evt_container', [
             ...
             ,{dom: '.m-text',x:0, y:50,duration:500,delay:200}
             ,{dom: '.sec-0 .row1',x:0, y:50,duration:500,delay:200}
             ,{dom: '.sec-0 .row2',x:0, y:50,duration:500,delay:200}
             ,{dom: '.sec-0 .row3',x:0, y:50,duration:500,delay:200}
            ...
            ,{dom: '.row5 .cake',x:-100, y:0,duration:500,delay:200}
            ,{dom: '.row5 .price',x:100, y:0,duration:500,delay:200}

            ,{dom: '.row6 .cake',x:100, y:0,duration:500,delay:200}
            ,{dom: '.row6 .price',x:-100, y:0,duration:500,delay:200}
        ])
    };
