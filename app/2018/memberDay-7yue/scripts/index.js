   ...
   /*推荐列表选择磅数*/
    ...
    var initScroll = function (){
        window.scrollAnimate('#evt_container', [
            ...
            ,{dom: '.b-l',x:-50, y:0,duration:500,delay:800}
            ,{dom: '.b-r',x:50, y:0,duration:500,delay:800}
            ,{dom: '.b-cake',x:-50, y:0,duration:500,delay:200}
            ,{dom: '.b-title',x:50, y:0,duration:500,delay:600}
