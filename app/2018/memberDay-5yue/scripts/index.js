   ...
   /*推荐列表选择磅数*/
    ...
    var initScroll = function (){
        window.scrollAnimate('#evt_container', [
             {dom: '.banner-1',x:-100, y:-50,duration:500,delay:400}
             ,{dom: '.banner-2',x:100, y:-50,duration:500,delay:800}
             ,{dom: '.banner-3',x:-100, y:50,duration:500,delay:1200}
             ,{dom: '.banner-4',x:100, y:50,duration:500,delay:1600}
             ,{dom: '.banner-title',x:0, y:100,duration:500,delay:200}

             ,{dom: '.sec-0 .quanyi',x:0, y:50,duration:500,delay:200}
             ,{dom: '.sec-jiangpin',x:0, y:100,duration:500,delay:400}
