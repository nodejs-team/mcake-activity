   ...
   /*推荐列表选择磅数*/
    ...
    Price.prototype={
        ...
        numInit:function () {
            ...
            this.$els.each(function () {
                ...
                $(this).find('.cost-price').html(totalOldprice);
                $(this).find('.ms-price').html(totalPrice);
            });
    ...
    var initScroll = function (){
        window.scrollAnimate('#evt_container', [
            {dom: '.sec-0 .word-1',x:0, y:50,duration:500,delay:200}
            ,{dom: '.sec-0 .title-1',x:0, y:50,duration:500,delay:200}
            ,{dom: '.sec-0 .jingxi',x:0, y:50,duration:500,delay:200}

             ,{dom: '.sec-main .title-1',x:0, y:50,duration:500,delay:400}
             ,{dom: '.row1 .cake',x:-100, y:50,duration:500,delay:400}
             ,{dom: '.row1 .price',x:0, y:50,duration:500,delay:400}
             ,{dom: '.sec-main .ms-time',x:0, y:50,duration:500,delay:400}

             ,{dom: '.sec-zp .title-3',x:0, y:50,duration:500,delay:400}
             ,{dom: '.sec-zp .haoli',x:0, y:50,duration:500,delay:400}
             ,{dom: '.sec-zp .quan-1',x:0, y:50,duration:500,delay:400}
             ,{dom: '.sec-zp .quan-2',x:0, y:50,duration:500,delay:400}
