;(function(){
    ...
    var initScroll = function (){
        window.scrollAnimate('#evt_container', [
            {dom: '.banner-logo',x:0, y:-100,duration:500,delay:200}
            ,{dom: '.banner-txt',x:-100, y:0,duration:500,delay:400}
            ,{dom: '.banner-cake',x:100, y:0,duration:500,delay:600}
            ,{dom: '.sec-0 .hongbao',x:0, y:50,duration:500,delay:200}
            ,{dom: '.sec-0 .content',x:0, y:50,duration:500,delay:400}
