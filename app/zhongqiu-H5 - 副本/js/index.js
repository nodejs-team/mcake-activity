var makeCards = {
    ...
    changeTxt:function () {
        $(".swiper-slide.swiper-slide-active").find("textarea").val("").fadeOut(0);
...
$(document).on("keyup","textarea",function(){
    console.log(get_length($(this).val()));


    var textarea=$(this).val(sub($(this).val(),100));
    var lastStr = parseInt(50-(textarea.val().len())/2);
    if(lastStr<=0){
        lastStr=0
    }
    $(".words samp").html("还可以输入<span>"+lastStr+"</span>个字");
});
