  ...
  var Scene6 = Element.extend({
    initialize: function () {
      ...
      var mainFlag = new Element({
        ...
        html: ImgElement("6-1_png", {width: 428})
      }).attr("data-swiper-parallax", "-800");

      var bg1 = new Element({
        className: "scene-bg1",
        html: ImgElement("6-2_png", {width: 896})
      }).attr("data-swiper-parallax", "-150");

      var bg2 = new Element({
        className: "scene-bg2",
        html: ImgElement("6-3_png", {width: 679})
      }).attr("data-swiper-parallax", "-300");

      var text = new Element({
        className: "scene-text",
        html: '<span class="scene-year">2017</span><h3>lapin détendu</h3><p>2017年，<br>你说，<br>每一个重要的时刻，<br>都需要甜蜜的鉴证，<br>安逸兔与属兔的你是冥冥之中的约定。</p>'
      });
