  ...
  var Scene8 = Element.extend({
    initialize: function () {
      ...
      var mainFlag1 = new Element({
        ...
        html: ImgElement("award_1_png", {width: 128})
      }).attr("data-swiper-parallax", "-800");

      var mainFlag2 = new Element({
        className: "scene-flag flag2",
        html: ImgElement("award_2_png", {width: 188})
      }).attr("data-swiper-parallax", "-1300");

      var mainFlag3 = new Element({
        className: "scene-flag flag3",
        html: ImgElement("award_3_png", {width: 141})
      }).attr("data-swiper-parallax", "-1800");

      var bg1 = new Element({
        className: "scene-bg2",
        html: ImgElement("8-2_png", {width: 648})
      }).attr("data-swiper-parallax", "-300");

      var bg2 = new Element({
        className: "scene-bg1",
        html: ImgElement("8-3_png", {width: 648})
      ...
      var text = new Element({
        ...
        <p><strong>活动时间：</strong><br>征集：2017年6月7日——2017年6月22日<br>\
          ...
          2017年7月3日---2017年7月14日，评选出最终方案。<br>\
          （微信，微博粉丝投票）<br>\
