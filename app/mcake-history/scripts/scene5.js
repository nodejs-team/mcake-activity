  ...
  var Scene5 = Element.extend({
    initialize: function () {
      ...
      var mainFlag = new Element({
        ...
        html: ImgElement("5-1_png", {width: 389})
      }).attr("data-swiper-parallax", "-800");

      var bg1 = new Element({
        className: "scene-bg1",
        html: ImgElement("5-2_png", {width: 818})
      }).attr("data-swiper-parallax", "-150");

      var bg2 = new Element({
        className: "scene-bg2",
        html: ImgElement("5-3_png", {width: 586})
      }).attr("data-swiper-parallax", "-300");

      var text = new Element({
        className: "scene-text",
        html: '<span class="scene-year">2016</span><p>天使的到来，<br>让幸福加磅，<br>卢克和咚咚是她最好的玩伴，<br>不过你先替他品尝。</p>'
      });
