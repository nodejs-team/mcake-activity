...
;(function () {
    ...
    choujiang.prototype={
        DialogTipShow:function (n,arr) {
            ...
            this.$DialogBox.find(".jp").css({"background":"url('https://mcake-act.oss-cn-hangzhou.aliyuncs.com/fangli/2019/wap/38jie/images/jiang-"+(n+1)+".png') center","background-size":"cover"});
        },
