;(function(){
    ...
    var initScroll = function (){
        window.scrollAnimate('#evt_container', [
            ...
            ,{dom: '.xbg-2',x:0, y:0,duration:800,delay:400}
            ,{dom: '.cake-2',x:50, y:0,duration:800,delay:200}
            ,{dom: '.xwords-2',x:-50, y:0,duration:800,delay:400}
            ,{dom: '.xwords-btn-2',x:0, y:50,duration:800,delay:600}
            ...
            ,{dom: '.pic',x:0, y:0,duration:800,delay:600}
            ,{dom: '.car-1',x:100, y:0,duration:800,delay:400}
            ,{dom: '.car-2',x:50, y:0,duration:800,delay:400}
            ,{dom: '.girl',x:-50, y:0,duration:800,delay:400}
            ,{dom: '.boy',x:50, y:0,duration:800,delay:400}
            ,{dom: '.cake-4',x:50, y:0,duration:800,delay:200}
            ,{dom: '.xwords-4',x:-50, y:0,duration:800,delay:400}
            ,{dom: '.xwords-btn-4',x:0, y:50,duration:800,delay:600}
