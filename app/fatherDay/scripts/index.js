;(function(){
    ...
    var loadComplete = function () {
       ...
       /*升磅*/
        ...
        $(".huangou .icon").each(function () {
            var huangou = true;
            var cakeSku =  $(this).parents(".price").find(".title").data("sku");  /*蛋糕*/
            var sku = $(this).data("sku"); /*巧克力牌*/
        ...
        /*巧克力牌*/
        var state = true;
        var sku = $(".gou").data("sku"); /*巧克力牌*/
        var cakeSku = $(".sCake").data("sku");  /*蛋糕*/
        $(".go-btn").attr("data-sku",cakeSku+","+sku);
        $(".gou").click(function () {
            if(state){
                $(".go-btn").attr("data-sku",cakeSku);
                $(this).removeClass("on");
                state = false;
            }else{
                $(".go-btn").attr("data-sku",cakeSku+","+sku);
        ...
        var pid = $(".select li.on").data("pid");
        $(".go-btn").attr("data-pid",pid);
        $(".select li").click(function () {
            $(this).addClass("on").siblings().removeClass("on");
            var self = $(this);
            var cSku = self.data("sku");
            pid = self.data("pid");
            $(".sCake").data("sku",cSku);
            cakeSku = $(".sCake").data("sku");
