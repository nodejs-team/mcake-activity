;(function () {
  ...
  function setNumber(hours, minites, seconds) {
    ...
    return '<span class="flip hour">' +
      '            <span><img src="http://edm.mcake.com/fangli/2017-wap/memberDay-new/images/' + hours.charAt(0) + '.png"/></span>' +
      '            <span><img src="http://edm.mcake.com/fangli/2017-wap/memberDay-new/images/' + hours.charAt(1) + '.png"/></span>' +
      '          </span>' +
      '          <span class="flip minite">' +
      '            <span><img src="http://edm.mcake.com/fangli/2017-wap/memberDay-new/images/' + minites.charAt(0) + '.png"/></span>' +
      '            <span><img src="http://edm.mcake.com/fangli/2017-wap/memberDay-new/images/' + minites.charAt(1) + '.png"/></span>' +
      '          </span>' +
      '          <span class="flip second">' +
      '            <span><img src="http://edm.mcake.com/fangli/2017-wap/memberDay-new/images/' + seconds.charAt(0) + '.png"/></span>' +
      '            <span><img src="http://edm.mcake.com/fangli/2017-wap/memberDay-new/images/' + seconds.charAt(1) + '.png"/></span>' +
      '          </span>';
  }
