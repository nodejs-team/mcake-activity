;(function(){
    ...
    var initScroll = function (){
        window.scrollAnimate('#evt_container', [
             {dom: '.b-title',x:-100, y:0,duration:500,delay:200},
             {dom: '.you',x:0, y:100,duration:500,delay:200},
             {dom: '.baoyouli',x:0, y:100,duration:500,delay:400},
             {dom: '.ad1',x:0, y:0,duration:500,delay:200},
             {dom: '.ad2',x:0, y:0,duration:500,delay:200}
    ...
    /*优惠券*/
    function DialogShow() {
        $(".Dialogbg-quan,.Dialog-quan").fadeIn(500);
    }
    function DialogHide() {
        $(".Dialogbg-quan,.Dialog-quan").fadeOut(0);
    }

    $(".q-closes,.Dialogbg-quan").click(function () {
        DialogHide();
    });
   ...
   /*数量选择*/
    ...
    window.DialogShow = DialogShow;
    window.DialogHide = DialogHide;
