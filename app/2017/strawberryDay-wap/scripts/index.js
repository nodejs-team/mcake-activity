;(function(){
    ...
    var animtion = {
        caomei_a:function () {
            ...
            new MovieClip('caomei_a', loader.get('caomei_a_png').data, formatResData(mcConfig)).play();
        },
        caomei_b:function () {
            //图片配置
            var mcConfig = [
        ...
        caomei_c:function () {
            //图片配置
            var mcConfig = {
                "caomei_b_1":{"x":1063,"y":0,"w":517,"h":505,"offX":59,"offY":31,"sourceW":599,"sourceH":567,"duration":5},
                "caomei_b_2":{"x":0,"y":507,"w":490,"h":505,"offX":86,"offY":31,"sourceW":599,"sourceH":567,"duration":1},
                "caomei_b_3":{"x":0,"y":0,"w":542,"h":505,"offX":34,"offY":31,"sourceW":599,"sourceH":567,"duration":1},
                "caomei_b_4":{"x":492,"y":507,"w":490,"h":505,"offX":86,"offY":31,"sourceW":599,"sourceH":567,"duration":1},
                "caomei_b_5":{"x":544,"y":0,"w":517,"h":505,"offX":59,"offY":31,"sourceW":599,"sourceH":567,"duration":25}
            }
            // MovieClip 可以通过duration控制两张图片轮播的速度。duration:0.2*10=2
            new MovieClip('caomei_c', loader.get('caomei_c_png').data, formatResData(mcConfig)).play();
        },
        monster_b:function () {
            //图片配置
            var mcConfig = [
