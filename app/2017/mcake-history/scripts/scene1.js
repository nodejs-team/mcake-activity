  ...
  var Scene1 = Element.extend({
    initialize: function () {
      ...
      var mainFlag = new Element({
        ...
        html: ImgElement("1-1_png", {width: 444})
      }).attr("data-swiper-parallax", "-800");

      var bg1 = new Element({
        className: "scene-bg1",
        html: ImgElement("1-2_png", {width: 853})
      }).attr("data-swiper-parallax", "-150");

      var bg2 = new Element({
        className: "scene-bg2",
        html: ImgElement("1-3_png", {width: 567})
      ...
      var text = new Element({
        ...
        '<div class="swipe-hint-text">左右滑动，发现更多</div>'
      });
      ...
      this.hintText = text.find(".swipe-hint-text");
